...
# copy from https://github.com/wondervictor/WiderFace-Evaluation
# and replace box overlaps with our interface
...
from xvision.ops.boxes import box_iou_pairwise


def bbox_overlaps(boxes1, boxes2):
    boxes1 = torch.from_numpy(boxes1)
    boxes2 = torch.from_numpy(boxes2)
    return box_iou_pairwise(boxes1, boxes2).numpy()
...
def get_preds(pred_dir):
    ...
    for event in pbar:
        ...
        event_images = event_dir.glob('*.txt')
        current_event = dict()
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-g', '--gt', default='/Users/Vic/Downloads/eval_tools/ground_truth/')
