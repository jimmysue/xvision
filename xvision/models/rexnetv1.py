...
class LinearBottleneck(nn.Module):
    def __init__(self, in_channels, channels, t, stride, use_se=True, se_ratio=12,
        ...
        out.append(nn.ReLU6())
        ConvBNAct(out, in_channels=dw_channels,
...
if __name__ == '__main__':
    ...
    torch.onnx.export(model, inputs, "rexnetv1.onnx",
                      opset_version=11, custom_opsets={'xvision': 1})
